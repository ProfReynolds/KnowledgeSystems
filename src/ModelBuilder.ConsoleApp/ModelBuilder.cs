...
using ModelBuilder.Model.DataModels;

namespace ModelBuilder.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\mark\OneDrive\dev\Datasets\Clustering_ Group iris data - training.csv";
        private static string MODEL_FILEPATH = @"../../../../ModelBuilder.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Label", "Label")
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "F1", "F2", "F3", "F4" }))
